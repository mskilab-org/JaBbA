...
test_that("JaBbA", {
    ...
    expect_true( ## accounting for difference in run speed local vs travis
        ...
        identical(jab$segstats$cn,
                  c(4, 3, 3, 1, 3, 10, 15, 20, 24, 28, 29, 30, 31, 32, 29, 30, 31, 32, 34, 32, 39, 28, 33, 28, 27, 25, 16, 5, 4, 3, 4, 8, 9, 6, 4, 3, 4, 3, 4, 3, 4, 4, 3, 3, 1, 3, 10, 15, 20, 24, 28, 29, 30, 31, 32, 29, 30, 31, 32, 34, 32, 39, 28, 33, 28, 27, 25, 16, 5, 4, 3, 4, 8, 9, 6, 4, 3, 4, 3, 4, 3, 4, 1, 1, 1, 2, 9, 1, 1, 2, 1, 1, 1, 7, 5, 5, 4, 4, 1, 1, 1, 1, 1, 1, 1, 7, 1, 1, 4, 1, 1, 1, 1, 7, 5, 5, 4, 4, 1, 1, 1, 1, 1, 1, 1, 7, 1, 1, 4, 1, 1, 1, 1, 1, 1, 1, 2, 9, 1, 1, 2, 1, 1, 1)),
    ...
    expect_true(abs(jab$ploidy - 3.7)<0.1 |
